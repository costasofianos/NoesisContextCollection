...
public record ContextCollectionInputJsonLine(
        String id,
        String repo,
        String revision,
        String path,
    ...
    public static ContextCollectionInputJsonLine fromJson(String json) throws JsonProcessingException {
        return objectMapper.readValue(json, ContextCollectionInputJsonLine.class);
    }

    public static ContextCollectionInputJsonLine fromJsonFile(File file) throws IOException {
        return objectMapper.readValue(file, ContextCollectionInputJsonLine.class);
    }
...
private String formatField(String heading, Object value) {
    ...
    public String toHeaderString() {
        return String.format("ID: %s | REPO: %s | REV: %s | PATH: %s",
                id,
                repo,
                revision,
                path
    ...
    public ContextCollectionInputJsonLine clone() {
        return new ContextCollectionInputJsonLine(
                this.id,
                this.repo,
                this.revision,
                this.path,
